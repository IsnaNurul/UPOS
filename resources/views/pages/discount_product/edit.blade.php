    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('discount-product.update', $product) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="product_id" value="{{ $product->name }}" readonly>
                                @error('product_id')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('discount') is-invalid @enderror"
                                    id="discountValue" name="discount" value="{{ $product->discount }}" placeholder="Enter discount value">
                                @error('discount')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
